#!/bin/bash
nit=5  # how often should this script be run (15)
...
do
  ...
  python create_dataset_remote.py -name 3DBC_CPFFT -nt $ntex \
  -ids $idx_start  \
  -dbp /storage/home/hcoda1/7/jschmidt87/scratch/3DBC_CPFFT \
  -sp /storage/home/hcoda1/7/jschmidt87/scratch/3DBC_CPFFT \
