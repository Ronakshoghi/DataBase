...
np.savetxt('{}/stress_11.out'.format(Key_Results_Path), Result1.sigma11Plot)
np.savetxt('{}/stress_22.out'.format(Key_Results_Path), Result1.sigma22Plot)
np.savetxt('{}/stress_33.out'.format(Key_Results_Path), Result1.sigma33Plot)
np.savetxt('{}/stress_12.out'.format(Key_Results_Path), Result1.sigma12Plot)
np.savetxt('{}/stress_23.out'.format(Key_Results_Path), Result1.sigma23Plot)
np.savetxt('{}/stress_13.out'.format(Key_Results_Path), Result1.sigma13Plot)
np.savetxt('{}/total_strain_11.out'.format(Key_Results_Path), Result1.strain11Plot)
np.savetxt('{}/total_strain_22.out'.format(Key_Results_Path), Result1.strain22Plot)
np.savetxt('{}/total_strain_33.out'.format(Key_Results_Path), Result1.strain33Plot)
np.savetxt('{}/total_strain_12.out'.format(Key_Results_Path), Result1.strain12Plot)
np.savetxt('{}/total_strain_13.out'.format(Key_Results_Path), Result1.strain13Plot)
np.savetxt('{}/total_strain_23.out'.format(Key_Results_Path), Result1.strain23Plot)
np.savetxt('{}/equivalent_strain.out'.format(Key_Results_Path), Result1.strainEPlot)
np.savetxt('{}/equivalent_stress.out'.format(Key_Results_Path), Result1.sigmaVPlot)
#np.savetxt('{}/plastic_strain_11.out'.format(Key_Results_Path), Result1.SDV156)
#np.savetxt('{}/plastic_strain_22.out'.format(Key_Results_Path), Result1.SDV157)
#np.savetxt('{}/plastic_strain_33.out'.format(Key_Results_Path), Result1.SDV158)
#np.savetxt('{}/plastic_strain_12.out'.format(Key_Results_Path), Result1.SDV159)
#np.savetxt('{}/plastic_strain_13.out'.format(Key_Results_Path), Result1.SDV160)
#np.savetxt('{}/plastic_strain_23.out'.format(Key_Results_Path), Result1.SDV161)
