...
np.savetxt('{}/strain_11.out'.format(Key_Results_Path), Result1.strain11Plot)
np.savetxt('{}/strain_22.out'.format(Key_Results_Path), Result1.strain22Plot)
np.savetxt('{}/strain_33.out'.format(Key_Results_Path), Result1.strain33Plot)
np.savetxt('{}/strain_12.out'.format(Key_Results_Path), Result1.strain12Plot)
np.savetxt('{}/strain_13.out'.format(Key_Results_Path), Result1.strain13Plot)
np.savetxt('{}/strain_23.out'.format(Key_Results_Path), Result1.strain23Plot)
