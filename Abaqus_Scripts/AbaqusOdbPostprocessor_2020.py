...
class OdbData(object):
       ...
       def F_CaclSigmaH(self, nodeObjectDict, dimension):
              ...
              #Initial Vectors
              y12_0 = np.asmatrix([[nodeObjectDict['V2'].x[0]-origin[0],nodeObjectDict['V2'].y[0]-origin[1],nodeObjectDict['V2'].z[0]-origin[2]]])
              y14_0 = np.asmatrix([[nodeObjectDict['V4'].x[0]-origin[0],nodeObjectDict['V4'].y[0]-origin[1],nodeObjectDict['V4'].z[0]-origin[2]]]) 
              if dimension=='3d':
                     y11_0 = np.asmatrix([[nodeObjectDict['H1'].x[0]-origin[0],nodeObjectDict['H1'].y[0]-origin[1],nodeObjectDict['H1'].z[0]-origin[2]]])
              else:
              ...
              for f in range(len(self.steptime)):
                     ...
                     y12 = np.asmatrix([[nodeObjectDict['V2'].x[f]-origin[0],nodeObjectDict['V2'].y[f]-origin[1],nodeObjectDict['V2'].z[f]-origin[2]]])
                     y14 = np.asmatrix([[nodeObjectDict['V4'].x[f]-origin[0],nodeObjectDict['V4'].y[f]-origin[1],nodeObjectDict['V4'].z[f]-origin[2]]])
                     if dimension=='3d':
                            y11 = np.asmatrix([[nodeObjectDict['H1'].x[f]-origin[0],nodeObjectDict['H1'].y[f]-origin[1],nodeObjectDict['H1'].z[f]-origin[2]]])
                     else:
                            y11 = np.asmatrix([nodeObjectDict['V1'].x[0],nodeObjectDict['V1'].y[0],nodeObjectDict['V1'].z[0]-1.0])
                     # Volume of a spart
                     ...
                     rf_V2 = np.asmatrix([[nodeObjectDict['V2'].rf1[f],nodeObjectDict['V2'].rf2[f],nodeObjectDict['V2'].rf3[f]]])
                     rf_V4 = np.asmatrix([[nodeObjectDict['V4'].rf1[f],nodeObjectDict['V4'].rf2[f],nodeObjectDict['V4'].rf3[f]]])
                     if dimension=='3d':
                            rf_H1 = np.asmatrix([[nodeObjectDict['H1'].rf1[f],nodeObjectDict['H1'].rf2[f],nodeObjectDict['H1'].rf3[f]]])
                     else:
                     ...
                     if dimension=='3d':
                            uH1 = np.asmatrix([[nodeObjectDict['H1'].u1[f],nodeObjectDict['H1'].u2[f],nodeObjectDict['H1'].u3[f]]])
                     else:
...
#       eps[1,0] = 0.5*(uV4[0,0]/dx2 + uV2[0,1]/dx1)
       eps[1,0] = 0.5*(uV4[0,0]/dx2 + uV2[0,1]/dx1 + (uV4[0,0]*uV2[0,0])/(dx1*dx2) + (uV4[0,1]*uV2[0,1])/(dx1*dx2) + (uV4[0,2]*uV2[0,2])/(dx1*dx2))	
#       eps[2,0] = 0.5*(-uH1[0,0]/dx3 + uV2[0,2]/dx1)	 
       eps[2,0] = 0.5*(-uH1[0,0]/dx3 + uV2[0,2]/dx1 + (-uH1[0,0]*uV2[0,0])/(dx1*dx3) + (-uH1[0,1]*uV2[0,1])/(dx1*dx3) + (-uH1[0,2]*uV2[0,2])/(dx1*dx3))
       #V4
       eps[0,1] = eps[1,0]
#       eps[1,1] = uV4[0,1]/dx2
       eps[1,1] = uV4[0,1]/dx2 + 0.5*((((uV4[0,1])**2) + ((uV4[0,2])**2)+ ((uV4[0,0])**2))/(dx2**2))
#       eps[2,1] = 0.5*(-uH1[0,1]/dx3 + uV4[0,2]/dx2) 
       eps[2,1] = 0.5*(-uH1[0,1]/dx3 + uV4[0,2]/dx2 + (-uH1[0,0]*uV4[0,0])/(dx1*dx3) + (-uH1[0,1]*uV4[0,1])/(dx1*dx3) + (-uH1[0,2]*uV4[0,2])/(dx2*dx3))
       #H1
       eps[0,2] = eps[2,0]
       eps[1,2] = eps[2,1]
#       eps[2,2] = -uH1[0,2]/dx3       
...
endStep=1
dimension='3d'
odbName = '/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/geometry_Periodic.odb'
# Definition of Result Files

#Result1
Result1=OdbData()
node=Result1.F_ODB('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/geometry_Periodic.odb', dimension, beginStep, endStep)
Result1.F_CaclSigmaH(node, dimension)

np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Stress11Plot1.out', Result1.sigma11Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Stress22Plot1.out', Result1.sigma22Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Stress33Plot1.out', Result1.sigma33Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Stress12Plot1.out', Result1.sigma12Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Stress23Plot1.out', Result1.sigma23Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Stress13Plot1.out', Result1.sigma13Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Strain11Plot1.out', Result1.strain11Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Strain22Plot1.out', Result1.strain22Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Strain33Plot1.out', Result1.strain33Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Strain12Plot1.out', Result1.strain12Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Strain13Plot1.out', Result1.strain13Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/Strain23Plot1.out', Result1.strain23Plot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/StrainEPlot1.out', Result1.strainEPlot)
np.savetxt('/home/users/shoghrm7/For_Ronak/Crystal_Plasticity_UMAT/Examples/Test-2/StressVPlot1.out', Result1.sigmaVPlot)
